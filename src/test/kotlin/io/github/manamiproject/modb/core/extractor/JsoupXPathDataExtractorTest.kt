...
internal class JsoupXPathDataExtractorTest {
        ...
        inner class LivechartExpressionsTests {
            ...
            fun `correctly parse most cases`() {
                runBlocking {
                    ...
                    assertThat(result.string("episodesDiv")).isEqualTo("Episodes  0 / 37")
                    ...
                    assertThat(result.string("season")).isEqualTo("Fall 2006")
